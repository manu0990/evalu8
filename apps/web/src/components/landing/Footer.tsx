      ...
      <div className="container mx-auto pt-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="mailto:manab.das.dev@gmail.com" className="text-gray-400 hover:text-white transition text-sm">Contact Us</Link></li>
              {/* <li><Link href="https://status.evalu8.com" className="text-gray-400 hover:text-white transition text-sm">Status</Link></li> */}
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-5 pb-3 border-t border-gray-800/50 gap-4">
            ...
            <div className="flex items-center space-x-6">
                ...
                <Link href="/cookies" className="text-sm text-gray-400 hover:text-white transition">Cookie Policy</Link>
            </div>
        </div>
      </div>
    </footer>
