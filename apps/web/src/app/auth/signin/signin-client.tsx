  ...
  return (
    <div className="flex justify-center items-center min-h-screen font-sans">
      <div className="w-full max-w-sm p-8 space-y-6 rounded-xl shadow-md">
        <h2 className="text-2xl font-bold text-center text-primary font-sans">
          Sign In
        </h2>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleCredentialSignIn)} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full rounded-full h-12 text-md font-sans font-medium mt-6 cursor-pointer"
              disabled={isLoading}
            >
        ...
        <div className="text-center text-sm text-muted-foreground font-sans">
          ...
          <Link href="/auth/signup" className="text-primary hover:underline font-sans">
            Sign up
          </Link>
        </div>
        ...
        <div className="space-y-3">
          <Button
            ...
            disabled={isLoading}
          >
            <Image src='/google-icon.svg' alt="google logo" width={25} height={25} className="text-foreground" />
          ...
          <Button
            ...
            disabled={isLoading}
          >
            <Image src='/github-icon.svg' alt="github logo" width={25} height={25} className="text-foreground" />
            <p className="font-sans">Sign in with GitHub</p>
          </Button>
        </div>
      </div>
    </div>
