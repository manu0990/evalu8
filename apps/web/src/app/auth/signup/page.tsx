    ...
    return (
      <div className="flex justify-center items-center min-h-screen font-sans">
        <div className="w-full max-w-sm p-8 space-y-6 rounded-xl shadow-md text-center">
          ...
          <h2 className="text-2xl font-bold text-primary mb-2 font-sans">Account Created!</h2>
          <p className="text-muted-foreground mb-4 font-sans">Signing you in now…</p>
          <div className="animate-pulse text-primary font-sans">Redirecting…</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex justify-center items-center min-h-screen font-sans">
      <div className="w-full max-w-sm p-8 space-y-6 rounded-xl shadow-md">
        <h2 className="text-2xl font-bold text-center text-primary font-sans">Create Account</h2>
        <Form {...form}>
        ...
        <p className="text-center text-sm text-muted-foreground font-sans">
          ...
          <Link href="/auth/signin" className="text-primary hover:underline font-sans">
            Sign in
          </Link>
        </p>
        ...
        <div className="space-y-3">
          {providers.map(({ id, label, icon }) => (
            <Button
              ...
              disabled={isLoading}
            >
              <Image src={icon} alt={`${label} logo`} width={25} height={25} className="text-foreground" />
